function [grad] = numgrad_makrnfsdc(q, r, curi, qdi, Ni, dsi,...
    k, lambda, h, dh)
% inputs
...
%        = [#dim x 1]
%
% See also MAKRNFSDC, NUMGRAD_MAKRNFSD.
%
% File:      numgrad_makrnfsdc.m
% Author:    Ioannis Filippidis, jfilippidis@gmail.com
% Date:      2011.09.20
% Language:  MATLAB R2011a
% Purpose:   MAKRNFSDC numerical gradient for 1 agent
...
for j=1:n
    q(:, curi) = pt(:, j);
    f(1, j) = makrnfsdc(q, r, curi, qdi, Ni, dsi, k, lambda, h);
end

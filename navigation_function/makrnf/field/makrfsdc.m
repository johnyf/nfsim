function [nf] = makrfsdc(q, r, i, qdi, Ni, dsi, k, lambda, h)
% Decentralized multi-agent Koditschek-Rimon function for spherical agents 
% under connectivity maintenance constraints
%
% usage
%   nf = MAKRFSDC(q, r, i, qdi, Ni, dsi, k, lambda, h)
%
% inputs
...
%
% output
%   nf = MAKRFSDC field function value for agent i
%        at configuration q(:, i)
%      = [1 x 1]
%
% See also NUMGRAD_MAKRFSDC, MAKRFSD.

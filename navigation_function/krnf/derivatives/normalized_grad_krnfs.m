function [grad] = normalized_grad_krnfs(q, qd, qc, r0, r, k)
% inputs
...
%
% outputs
%   grad = KRNF gradient at points q
%        = [#dim x #points]
%
% See also KRNFS, GRAD_KRNF, GRAD_FREE.
%   
% File:      normalized_grad_krnfs.m
% Author:    Ioannis Filippidis, jfilippidis@gmail.com
% Date:      2010.10.02 - 2011.09.10
% Language:  MATLAB R2011a
% Purpose:   Koditschek-Rimon analytical formula for normalized gradient
%            in (model) sphere world

function [hafspaces] = create_halfspaces(qp, n, domain)
...
%
% See also CREATE_HALFSPACE, ADD_HALFSPACE, BETA_HALFSPACES.
...
for i=1:nobs
    ...
    halfspace = create_halfspace(curqp, curn, curdomain);
